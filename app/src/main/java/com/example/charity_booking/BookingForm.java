...
public class BookingForm extends AppCompatActivity implements AdapterView.OnItemSelectedListener, View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final String cid = intent.getStringExtra(CharityList.EXTRA_TEXT);
        ...
        confirmbtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                appointment.put("Date", txtDate.getText().toString());
        ...
        DatePickerDialog datePickerDialog = new DatePickerDialog(BookingForm.this, new DatePickerDialog.OnDateSetListener() {
            ...
            public void onDateSet(DatePicker view, int year, int monthOfYear, int dayOfMonth) {
                ...
                slots.add("17:00");
                    ...
                    Log.d(TAG, "booker");
                    DocumentReference docRef1 = fstore.collection("8:00").document(txtDate.getText().toString());
                    ...
                    DocumentReference docRef2 = fstore.collection("9:00").document(txtDate.getText().toString());
                    ...
                    DocumentReference docRef3 = fstore.collection("10:00").document(txtDate.getText().toString());
                    ...
                    DocumentReference docRef4 = fstore.collection("11:00").document(txtDate.getText().toString());
                    ...
                    DocumentReference docRef5 = fstore.collection("12:00").document(txtDate.getText().toString());
                    ...
                    DocumentReference docRef6 = fstore.collection("13:00").document(txtDate.getText().toString());
                    ...
                    DocumentReference docRef7 = fstore.collection("14:00").document(txtDate.getText().toString());
                    ...
                    DocumentReference docRef8 = fstore.collection("15:00").document(txtDate.getText().toString());
                    docRef8.get().addOnCompleteListener(new OnCompleteListener<DocumentSnapshot>() {
                        ...
                        public void onComplete(@NonNull Task<DocumentSnapshot> task) {
                            if (task.isSuccessful()) {
                                ...
                                if (document.exists()) {
                                    slots.remove("15:00");
                                    Log.d(TAG, "booker" + txtDate.getText().toString());
                                } else {
                    ...
                    DocumentReference docRef9 = fstore.collection("16:00").document(txtDate.getText().toString());
                    ...
                    DocumentReference docRef10 = fstore.collection("17:00").document(txtDate.getText().toString());
                    ...
                    ArrayAdapter<String> spinnerArrayAdapter = new ArrayAdapter<String>(BookingForm.this, android.R.layout.simple_spinner_item, slots);
