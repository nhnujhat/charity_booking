...
public class UserBookings extends AppCompatActivity implements AdapterView.OnItemSelectedListener {
    RecyclerView mRecyclerView;
    FirebaseAuth fAuth;
    FirebaseFirestore dbBooking;
    ArrayList<Booking> bookingArrayList;
    BookingAdapter adapter;
    Button userhistorybtn;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mRecyclerView = findViewById(R.id.bookingRV);
        mRecyclerView.setHasFixedSize(true);
        mRecyclerView.setLayoutManager(new LinearLayoutManager(this));

        userhistorybtn = (Button) findViewById(R.id.userhistorybtn);

        userhistorybtn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                startActivity(new Intent(getApplicationContext(), UserBookingsHistory.class));
            }
        });
        ...
        dbBooking.collection("Appointments")
                ...
                .addOnCompleteListener(new OnCompleteListener<QuerySnapshot>() {
                    ...
                    public void onComplete(@NonNull Task<QuerySnapshot> task) {
                        ...
                        adapter = new BookingAdapter(UserBookings.this, bookingArrayList);
                ...
                .addOnFailureListener(new OnFailureListener() {
                    ...
                    public void onFailure(@NonNull Exception e) {
                        Toast.makeText(UserBookings.this, "Problem ---I---", Toast.LENGTH_SHORT).show();
