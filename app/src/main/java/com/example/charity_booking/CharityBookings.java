...
public class CharityBookings extends AppCompatActivity implements AdapterView.OnItemSelectedListener {
    RecyclerView mRecyclerView;
    FirebaseAuth fAuth;
    FirebaseFirestore dbBooking;
    ArrayList<Booking> bookingArrayList;
    BookingAdapterCharity adapter;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        setTitle("Charity App");
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_charity_bookings);

        bookingArrayList = new ArrayList<>();

        fAuth = FirebaseAuth.getInstance();
        mRecyclerView = findViewById(R.id.charitybookingRV);
        ...
        dbBooking.collection("Appointments")
                .whereEqualTo("Charityid", fAuth.getCurrentUser().getUid())
                .get()
                .addOnCompleteListener(new OnCompleteListener<QuerySnapshot>() {
                    ...
                    public void onComplete(@NonNull Task<QuerySnapshot> task) {
                        for (DocumentSnapshot querySnapshot : task.getResult()) {
                            Booking booking = new Booking(querySnapshot.getString("Name"),
                            ...
                            if(strdate.charAt(2)==div && strdate.charAt(4)==div) {
                                ...
                                if(date.isAfter(date2)||date.isEqual(date2)) bookingArrayList.add(booking);
                            }
                        ...
                        adapter = new BookingAdapterCharity(CharityBookings.this, bookingArrayList);
                ...
                .addOnFailureListener(new OnFailureListener() {
                    ...
                    public void onFailure(@NonNull Exception e) {
                        Toast.makeText(CharityBookings.this, "Problem ---I---", Toast.LENGTH_SHORT).show();
